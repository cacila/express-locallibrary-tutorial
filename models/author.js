...
//Virtual for author's date_of_birth_formatted_update
AuthorSchema
.virtual('date_of_birth_formatted_update')
.get(function () {
  return moment(this.date_of_birth).format('YYYY-MM-DD');
});

//Virtual for author's date_of_death_formatted_update
AuthorSchema
.virtual('date_of_death_formatted_update')
.get(function () {
